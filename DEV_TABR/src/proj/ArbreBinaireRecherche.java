...
public class ArbreBinaireRecherche{
	...
	/**
	 * maxValeur permet de retourner la valeur maximale contenue dans l'arbre
	 * @return renvoie le plus grand entier de l'arbre
	 */
	public int getMin(){
		int min = 0;
		NoeudBinaire nb = this.getRacine();
