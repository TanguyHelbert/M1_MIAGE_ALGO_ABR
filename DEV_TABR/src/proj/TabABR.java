...
public class TabABR {
	...
	/**
	 * 2.1.2 : generateRandomTABR permet de generer, aleatoirement, la totalite d'un TABR ou T[1].debut = 1 et T[n].fin = m et ou chaque ABR contient au moins 3 elements
...
//			System.out.println("[min_case] : " +min_case+ " [max_case] : "+max_case + " // ");
	...
	/**
	 * generateRandomABR est utilise dans la fonction precedente generant aleatoirement un TABR
	 * @param min_abr
	 * @param max_abr
	 * @param taille_intervalle_abr
	 * @return
	 */
	private ArbreBinaireRecherche generateRandomABR(int min_abr, int max_abr, int taille_intervalle_abr) {
		int nb_elements;
